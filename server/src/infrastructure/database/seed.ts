...
const seedData = async () => {
  ...
  try {
    ...
    const leads = [
      ...
      { name: 'Evergreen Solutions', email: 'hello@evergreen.io', phone: '+1-555-0115', company: 'Evergreen Solutions', status: LeadStatus.NEW, source: LeadSource.WEBSITE, value: 16000, notes: 'Inbound lead from B2B blog', createdBy: admin._id },
    ];
