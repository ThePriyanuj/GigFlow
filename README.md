...
After deploying the backend, run the seed:
```bash
# Or call the health endpoint to trigger auto-seed
curl https://your-backend.vercel.app/api/health
```

The server auto-seeds demo users and leads on first startup when the database is empty.
